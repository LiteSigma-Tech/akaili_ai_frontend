    ...
    <div class="max-w-7xl mx-auto px-6">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-24">
        ...
        <div class="relative" data-aos="fade-left">
          ...
          <div
            class="absolute inset-0 bg-gradient-to-r from-[#9E4CFF] to-blue-600 opacity-10 blur-3xl rounded-full"
          ></div>
          <!-- Illustration / Image Placeholder -->
          <div
            class="relative bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 rounded-2xl p-8 shadow-2xl"
          >
            <div class="grid grid-cols-2 gap-4">
              <div
                class="bg-gray-50 dark:bg-slate-800 p-4 rounded-xl text-center"
              >
                <span class="block text-3xl font-bold text-[#9E4CFF] mb-1"
                  >99%</span
                >
              ...
              <div
                class="bg-gray-50 dark:bg-slate-800 p-4 rounded-xl text-center"
              >
                <span class="block text-3xl font-bold text-blue-500 mb-1"
                  >24/7</span
                >
                <span class="text-xs text-gray-500 uppercase tracking-wide"
                  >Availability</span
              ...
              <div
                class="col-span-2 bg-gray-50 dark:bg-slate-800 p-4 rounded-xl flex items-center justify-between"
              >
                <div class="text-left">
                  <span
                ...
                <div
                  class="h-10 w-10 bg-[#9E4CFF] rounded-full flex items-center justify-center text-white"
                >
                  <svg
                    class="w-6 h-6"
                    fill="none"
      ...
      <div class="mb-24">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            <div
              class="w-12 h-12 rounded-lg bg-purple-50 dark:bg-purple-900/20 flex items-center justify-center mb-6 text-[#9E4CFF]"
            >
...
<script setup>
import { ShieldCheck, Zap, Users } from "lucide-vue-next";
...
const values = [
  {
    ...
    description:
      "Your data is your asset. We employ enterprise-grade encryption and strict access controls to ensure your knowledge base remains secure.",
    icon: ShieldCheck,
  },
  {
    title: "Lightning Fast",
    description:
      "Speed matters. Our optimized LLM architecture ensures your customers get accurate answers in milliseconds, not minutes.",
    icon: Zap,
  },
  {
    title: "Customer Centric",
    description:
      "We build features based on what you need. Our roadmap is driven by user feedback and real-world support challenges.",
    icon: Users,
  },
];
